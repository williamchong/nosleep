  ...
  >
    <div class="text-center space-y-2">
      <div class="flex items-center justify-center space-x-2">
        ...
        <h3 class="text-xl font-bold text-indigo-900 dark:text-indigo-100">{{ $t('floatingWindow.title') }}</h3>
      </div>
      <p class="text-sm text-indigo-700 dark:text-indigo-300">{{ $t('floatingWindow.subtitle') }}</p>
    </div>
